...
static const unsigned int MAX_BLOCK_SIZE = 150000;                      // 150KB block hard limit
/** Obsolete: maximum size for mined blocks */
static const unsigned int MAX_BLOCK_SIZE_GEN = MAX_BLOCK_SIZE/4;         // 37.5KB  block soft limit
