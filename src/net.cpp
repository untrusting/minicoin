...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Minicoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"minicointools.com", "dnsseed.minicointools.com"},
    {"minicoinpool.org", "dnsseed.minicoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"minicointools.com", "testnet-seed.minicointools.com"},
